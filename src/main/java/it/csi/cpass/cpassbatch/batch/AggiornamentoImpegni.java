...
public class AggiornamentoImpegni extends BatchBase {

	private Integer numElab = 0;

	public AggiornamentoImpegni(String pathBase, String enteCodice, String utenteBatch, Integer numElab,
			String[] param) {
	...
	public void execute() throws SQLException, NamingException, IOException, InterruptedException {
		final String urlServizio = CpassBatchEnum.AGGIORNAMENTI_IMPEGNI.getCostante();
