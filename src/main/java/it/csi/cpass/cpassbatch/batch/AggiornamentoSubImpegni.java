...
public class AggiornamentoSubImpegni extends BatchBase {

	private Integer numElab = 0;

	public AggiornamentoSubImpegni(String pathBase, String enteCodice, String utenteBatch, Integer numElab,
			String[] param) {
	...
	public void execute() throws SQLException, NamingException, IOException, InterruptedException {
		final String urlServizio = CpassBatchEnum.AGGIORNAMENTI_SUBIMPEGNI.getCostante();
