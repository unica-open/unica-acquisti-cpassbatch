...
public class CaricamentoAggiornamentoSubImpegni extends BatchBase {

	private Integer numElab = 0;

	public CaricamentoAggiornamentoSubImpegni(String pathBase, String enteCodice, String utenteBatch, Integer numElab,String[] param) {
	...
	public void execute() throws SQLException, NamingException, IOException, InterruptedException {
		final String urlServizio = CpassBatchEnum.CARICAMENTO_AGGIORNAMENTI_SUBIMPEGNI.getCostante();
