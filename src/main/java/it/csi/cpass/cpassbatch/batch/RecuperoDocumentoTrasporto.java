...
public class RecuperoDocumentoTrasporto extends BatchBase {

	public RecuperoDocumentoTrasporto(String pathBase, String enteCodice, String utenteBatch, String[] param) {
	...
	public void execute() throws IOException, InterruptedException {
		String urlServizio = CpassBatchEnum.RECUPERO_DDT.getCostante();
