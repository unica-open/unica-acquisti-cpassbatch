...
public class StoricizzaDdt extends BatchBase {

	public StoricizzaDdt(String pathBase, String enteCodice, String utenteBatch, String[] param) {
	...
	public void execute() throws IOException, InterruptedException {
		final String urlServizio = CpassBatchEnum.STORICIZZA_FILE_DDT.getCostante();
