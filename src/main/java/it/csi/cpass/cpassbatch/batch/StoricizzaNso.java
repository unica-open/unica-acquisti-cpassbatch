...
public class StoricizzaNso extends BatchBase {

	public StoricizzaNso(String pathBase, String enteCodice, String utenteBatch, String[] param) {
	...
	public void execute() throws IOException, InterruptedException {
		final String urlServizio = CpassBatchEnum.STORICIZZA_FILE_NSO.getCostante();
