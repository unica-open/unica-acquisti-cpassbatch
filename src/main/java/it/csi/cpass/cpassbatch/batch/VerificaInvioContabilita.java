...
public class VerificaInvioContabilita extends BatchBase {

	public VerificaInvioContabilita(String pathBase, String enteCodice, String utenteBatch, String[] param) {
	...
	public void execute() throws IOException, InterruptedException {
		String urlServizio = CpassBatchEnum.VERIFICA_INVIO_CONTABILITA.getCostante();// "batch/verifica-invio-contabilita/";//
		// da valorizzare con il patd
		// dell'enum dei servizzi
